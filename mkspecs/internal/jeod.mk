# This makefile is a slightly modified version of JEOD's generic_S_overrides.mk
# provided in ${JEOD_HOME}/bin/jeod. It skips some of the logic for rebuilding
# the Trickified JEOD library as part of the sim build.
#
# This file is intended for internal use by CML unit sims ONLY. CML makes no
# guarantee that this makefile will work properly for external projects.
...
ifeq (${TRICKIFIED_EXISTS},0)
  ...
  $(DE4XX_SRC):
	@echo "JEOD JPL DE4XX ephemeris Library not built."
	exit -1
endif

# Build the trickified JEOD library and JEOD model library if needed.
$(JEOD_TRICKBUILD_LIB):
	@echo "JEOD Library not built."
	exit -1

$(TRICKIFIED_JEOD_LIB):
	@echo "JEOD Trickified Library not built."
	exit -1
