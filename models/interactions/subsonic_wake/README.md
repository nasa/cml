...
Provides a wake-force for the interaction between two vehicles that are
separate but still in proximity to one another within the atmosphere.
Has known issues with implementation.
