...
drg2.add_variable("events_manager_verif.manager.base_double_verif.event_triggered")
drg2.add_variable("events_manager_verif.manager.base_bool_verif.event_triggered")
drg2.add_variable("events_manager_verif.manager.reference_var_verif.event_triggered")
drg2.add_variable("events_manager_verif.manager.relative_to_activation_int_verif.event_triggered")
drg2.add_variable("events_manager_verif.manager.relative_to_activation_bool_verif.event_triggered")
drg2.add_variable("events_manager_verif.manager.relative_to_activation_float_verif.event_triggered")
