...
This model provides a "piggy-back" atmosphere so that parachutes -- which are
located at a substantially different altitude than their respective vehicle --
can have accurate atmospheric data for their positions.
