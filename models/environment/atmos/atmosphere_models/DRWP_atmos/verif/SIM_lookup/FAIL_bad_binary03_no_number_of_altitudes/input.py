...
# This one tests the effect of having no specification for the number
# of altitude-based calibration points.
exec(open( "input_common.py").read())
luwinds.lookup_table_winds.load_DRWP_file("Binaries/corrupt_binaries/no_number_of_altitudes.bin", True, 11)
