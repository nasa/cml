...
# of profile numbers, in this case, the array is truncated and incomplete.
exec(open( "input_common.py").read())
luwinds.lookup_table_winds.load_DRWP_file("Binaries/corrupt_binaries/short_profile_array.bin", True, 11)
