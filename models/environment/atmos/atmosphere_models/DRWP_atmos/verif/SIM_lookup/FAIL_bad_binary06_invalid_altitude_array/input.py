...
# of altitude-based calibration points, in this case, the array is not
# monotonic.
exec(open( "input_common.py").read())
luwinds.lookup_table_winds.load_DRWP_file("Binaries/corrupt_binaries/invalid_altitude_array.bin", True, 11)
