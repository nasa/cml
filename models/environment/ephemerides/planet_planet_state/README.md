...
Provides the state of one planet relative to another.  This can be useful, for
example when needing the state of a vehicle wrt Sun when it is only known wrt
Earth, but the Earth-Sun state can also be obtained.
