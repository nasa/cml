...
%      atlas_alignment(lat_ix,lon_ix) = rad2deg(acos(-data(row, 5)));
  ...
  set(gca, 'FontSize',13)
  title(strcat('LP150Q: Magnitude of Gravitational Acceleration at Radius:',radius,'km and Field: 150x150'),'fontsize',20)
  ...
  print (strcat('LP150Q_gravity_map_',radius,'_150x150.png'),"-S2000,1000")
