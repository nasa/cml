...
This model provides a periodic dynamic perturbation to the state of a vehicle
being held on the launch pad.  It works alongside the Trajectory model, which
is necessary to hold the vehicle at the launch pad.
