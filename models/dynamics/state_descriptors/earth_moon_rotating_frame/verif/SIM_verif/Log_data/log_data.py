...
#add_3vec( dr_group,"vehicle.body.composite_body.state.trans.position")
add_3vec( dr_group,"vehicle.rel_state.rel_state.trans.position")
add_3vec( dr_group,"vehicle.rel_state.rel_state.trans.velocity")
dr_group.add_variable( "test.em_rotating_frame.pointing_frame.state.rot.ang_vel_this[2]")
add_3x3( dr_group, "test.em_rotating_frame.pointing_frame.state.rot.T_parent_this")
