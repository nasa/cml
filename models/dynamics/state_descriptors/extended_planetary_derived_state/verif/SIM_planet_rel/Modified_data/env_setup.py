...
vehicle.body.grav_interaction.add_control( vehicle.grav_controls_earth )
...
vehicle.state_initialize.ref_point_altitude = 10000
vehicle.state_initialize.ref_point_latitude = 0.55
vehicle.state_initialize.ref_point_longitude = -1.5
vehicle.state_initialize.velocity = [0, 7000, 0]
...
# Planet rel-state
vehicle.planet_rel_state.reference_name = "Earth"
