...
class TopoContainer {
 ...
 protected:
  ...
  const jeod::RefFrameRot * planet_rot_state{nullptr};  /* (--) Pointer to planet's  rotational state */
  const jeod::RefFrameRot * vehicle_rot_state{nullptr}; /* (--) Pointer to vehicle's rotational state */
