...
Provides the state of a vehicle realtive to the atmosphere through which it is
moving; state parameters are typically atmosphere-related, e.g. mach-number.
