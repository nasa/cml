...
This model provides a subset of orbital elements, primarily in support of the
apsides-prediction and impact-point prediction models.  For full orbital
elements representations, use the JEOD model.
