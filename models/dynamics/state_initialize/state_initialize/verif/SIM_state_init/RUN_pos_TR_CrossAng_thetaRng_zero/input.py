...
# Range angle:                 0 deg --> Position vector will not be rotated
#
# The inputs will result in a divide-by-zero situation.
# A warning will be output and the simulation will terminate.
...
vehicle.state_initialize.TR_theta_Rng                    = 0.0
