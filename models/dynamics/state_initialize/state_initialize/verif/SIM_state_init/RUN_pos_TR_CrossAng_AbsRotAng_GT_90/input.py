...
# Cross angle:                180 deg --> Position vector will be rotated along the great circle with 0 deg longitude
...
vehicle.state_initialize.position_input_data_type        = trick.StateInitialize.TR_GeodAlt_RngAng_CrossAng_AbsRotAng_GT_90
