...
rocket_motor.motor_prop_string.add_mass_to_string( rocket_motor.motor_prop_a)
rocket_motor.motor_prop_string.add_mass_to_string( rocket_motor.motor_prop_b)
