...
:doc:`coding standards <coding-standards>`.

.. important::

    All submissions to CML must be free of ITAR, EAR, and CUI content. CML is an
    open-source project. Submissions containing export-controlled, proprietary, or
    other sensitive data will be automatically rejected.
...
which adequately describes the model. See the :doc:`coding standards <coding-standards>`
...
- Pull requests, issues, comments, and any other submission to the CML
